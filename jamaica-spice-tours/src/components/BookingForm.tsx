...
export default function BookingForm({ tours, selectedTourId, setSelectedTourId }: BookingFormProps) {
  ...
  💳 PAY $40 USD VIA PAYPAL
    ...
    <button 
      type="button" 
      onClick={() => window.open('https://wa.me/18769896889?text=✅ *New Booking Paid & Confirmed!*%0A%0A📍 *Trail:* Doctors Cave Beach Excursion%0A📅 *Date:* 2026-06-20%0A👥 *Passengers:* 2 Guests%0A💵 *Amount Settled:* $40 USD (via PayPal)', '_blank')} 
...
<button 
    ...
    style={{ width: '100%', backgroundColor: '#25D366', color: '#fff', padding: '16px', borderRadius: '12px', fontWeight: 900, border: 'none', cursor: 'pointer', fontSize: '1rem', marginTop: '12px' }}
>
    📲 INSTANT CONFIRM ON WHATSAPP ➔
</button>
